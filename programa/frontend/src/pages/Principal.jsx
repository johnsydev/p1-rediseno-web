          ...
          <div className="carreras-grid">
            {carreras.map((carrera) => (
              <div key={carrera.id} className="carrera-card">
                <div className="carrera-image-wrapper">
                  <img 
                    src={carrera.imagen} 
                    alt={carrera.titulo}
                    className="carrera-image"
                  />
                  <div className="carrera-overlay"></div>
                </div>
                
                <div className="carrera-content">
                  <h3 className="carrera-titulo">{carrera.titulo}</h3>
                  <a href={carrera.link} className="carrera-btn">
                    VER
                  </a>
                </div>
              </div>
            ...
            <div className="timeline-items">
              <div className="timeline-item">
                ...
                <div className="timeline-card">
                  ...
                  <p className="sede-telefono">2664-5378 / 2664-3838 / 6037-5287</p>
                </div>
              </div>
        ...
        <div className="sobre-container">
          ...
          <div className="sobre-content">
            <div className="sobre-video-column">
              ...
              <a href="/nosotros" className="sobre-btn">
                Conocer Más
              </a>
            </div>
